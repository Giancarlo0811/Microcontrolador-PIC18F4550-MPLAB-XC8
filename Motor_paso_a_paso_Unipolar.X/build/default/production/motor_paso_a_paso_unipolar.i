# 1 "motor_paso_a_paso_unipolar.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "motor_paso_a_paso_unipolar.c" 2
...
# 17 "motor_paso_a_paso_unipolar.c" 2




unsigned char pasos[4] = {0b1100, 0b0110, 0b0011, 0b1001};
...
void pasos_izquierda(void) {
    for (signed char i = 0; i < 4; i++) {
        LATD = pasos[i];
        _delay((unsigned long)((2000)*(48000000/4000000.0)));
    }
}
